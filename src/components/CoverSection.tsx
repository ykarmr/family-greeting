    ...
    >
      ...
      <div className="absolute top-8 md:top-12 w-full px-8 md:px-16 flex justify-between items-end z-10">
        <div className="flex flex-col items-start gap-1">
          <span className="text-xs md:text-sm tracking-[0.3em] font-serif uppercase text-[var(--color-text-light)]">
            Family Greeting
          </span>
          <span className="text-base md:text-lg font-bold font-serif tracking-widest border-b border-[var(--color-text)] pb-1">
            創刊号
          </span>
        </div>
        <div className="flex flex-col items-end gap-1">
          <span className="text-xs md:text-sm tracking-[0.2em] font-serif text-[var(--color-text-light)]">
            製作者
          </span>
      ...
      >
        ...
        <div className="mt-6 md:mt-8 flex justify-center items-center gap-4">
          ...
          <span className="font-serif italic text-xl md:text-2xl text-[var(--color-sage-dark)]">
            The Two Families
          </span>
          <div className="h-[1px] w-12 bg-[var(--color-text-light)] opacity-50"></div>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 z-10 opacity-60">
        <span className="text-xs tracking-[0.5em] uppercase font-serif">
          Scroll Down
        </span>

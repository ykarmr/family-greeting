    ...
    <section ref={ref} className="px-6 md:px-12 lg:px-20 py-24 bg-[var(--color-cream)] relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative">
         ...
         <div 
           ...
           style={{
             backgroundImage: "repeating-linear-gradient(transparent, transparent 2.4rem, #E8E4D9 2.4rem, #E8E4D9 2.5rem)"
           }}
         >
            {/* スタンプ装飾 */}
         ...
         {/* 封筒の飾り風 */}
         <div className={`absolute -bottom-6 -right-6 md:-bottom-10 md:-right-12 w-32 h-32 md:w-48 md:h-48 transition-all duration-1000 delay-300 ${isInView ? "opacity-100 rotate-12" : "opacity-0 rotate-0"}`}>
             {/* 葉っぱのSVGなどの代わり */}
             <span className="text-6xl md:text-8xl text-[var(--color-sage)] opacity-20 filter blur-[1px]">🌿</span>
         </div>
      </div>
    </section>
  );
